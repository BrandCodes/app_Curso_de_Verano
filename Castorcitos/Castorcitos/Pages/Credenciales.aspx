<%@ Page Language="C#" MasterPageFile="~/Pages/FormatoAdmin.Master" AutoEventWireup="true" CodeBehind="Credenciales.aspx.cs" Inherits="Castorcitos.Pages.Credenciales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td colspan="4"><center><img id="img" width="250" height="250" style="border-radius:143px 143px 143px 0px;" /></center> </td>
                </tr>
                <tr>                    
